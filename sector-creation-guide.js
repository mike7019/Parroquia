...
console.log('   2. Documentación personalizada en /api-docs-custom');
console.log('   3. Endpoint específico para esquema en /sector-schema');
...
console.log('• Swagger Personalizado: http://localhost:3000/api-docs-custom');
console.log('• Esquema de Sector:     http://localhost:3000/sector-schema');
