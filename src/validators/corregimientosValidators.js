...
const corregimientosValidators = {
  /**
   * Validación para crear un corregimiento
   */
  validateCreate: [
    body('nombre')
      .trim()
  ...
  /**
   * Validación para actualizar un corregimiento
   */
  validateUpdate: [
    param('id')
      .isInt({ min: 1 }).withMessage('El ID del corregimiento debe ser un número entero positivo'),
  ...
  validateQuery: [
    ...
    query('sortBy')
      .optional()
      .isIn(['id_corregimiento', 'nombre', 'codigo_corregimiento', 'created_at', 'updated_at'])
...
export default corregimientosValidators;
