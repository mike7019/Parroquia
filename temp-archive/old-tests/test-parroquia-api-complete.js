...
async function testParroquiaAPI() {
  try {
    ...
    console.log(`✅ Resultados de búsqueda: ${resultadosBusqueda.parroquias?.length || 0} parroquias encontradas`);
    ...
    console.log(`✅ Total de parroquias: ${todasParroquias.total || todasParroquias.parroquias?.length || 'N/A'}`);
