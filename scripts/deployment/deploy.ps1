...
Write-Host ""
Write-ColorOutput Blue "🌐 API URL: http://localhost:3000/api"
Write-ColorOutput Blue "📚 Documentación: http://localhost:3000/api-docs"
Write-ColorOutput Blue "💚 Health Check: http://localhost:3000/api/health"
Write-Host ""
