...
async function testEstadisticasSalud() {
  try {
    ...
    console.log('📊 Paso 2: Consultando estadísticas de salud...\n');
    
    // Consultar estadísticas de salud
    const estadisticasResponse = await axios.get('http://localhost:3000/api/estadisticas/salud', {
      headers: {
