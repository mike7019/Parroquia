...
echo "🔧 Reparando endpoint de encuestas..."

# Hacer backup del archivo original
cp src/controllers/encuestaController.js src/controllers/encuestaController.js.backup

# Crear un archivo temporal con solo la función obtenerEncuestas corregida
...
echo "✅ Función reparada creada"
echo "⚠️ IMPORTANTE: Debes reemplazar manualmente la función obtenerEncuestas"
echo "   en src/controllers/encuestaController.js con el contenido de /tmp/new_function.js"
