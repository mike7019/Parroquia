...
// Importar modelos
const Sexo = require('./models/Sexo')(sequelize, Sequelize.DataTypes);
const Persona = require('./models/Persona')(sequelize, Sequelize.DataTypes);

// Configurar asociaciones
Sexo.associate({ Persona });
Persona.associate({ Sexo });
