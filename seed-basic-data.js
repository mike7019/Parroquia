...
async function seedBasicData() {
  try {
    ...
    // 1. Check and create departamentos first (required by municipios)
    ...
    if (deptosCount === 0) {
      ...
      await sequelize.query(`
        INSERT INTO departamentos (id_departamento, nombre_departamento, created_at, updated_at) 
    ...
    if (municipiosCount === 0) {
      ...
      await sequelize.query(`
        INSERT INTO municipios (id_municipio, nombre_municipio, id_departamento, created_at, updated_at) 
    ...
    if (veredasCount === 0) {
      ...
      await sequelize.query(`
        INSERT INTO veredas (id_vereda, nombre_vereda, id_municipio, created_at, updated_at) 
    ...
    if (sectoresCount === 0) {
      ...
      await sequelize.query(`
        INSERT INTO sectores (id_sector, nombre_sector, id_vereda, created_at, updated_at) 
