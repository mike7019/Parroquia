...
try {
    ...
    $createResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/departamentos" -Method POST -Headers $headers -Body $createData
    $departamentoId = $createResponse.data.id
    Write-Host "CREATE exitoso - ID: $departamentoId" -ForegroundColor Green
    
    # READ ALL
    $readAllResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/departamentos" -Method GET -Headers $headers
    Write-Host "READ ALL exitoso - Total: $($readAllResponse.data.Count)" -ForegroundColor Green
    
    # READ BY ID
    $readByIdResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/departamentos/$departamentoId" -Method GET -Headers $headers
    ...
    $updateResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/departamentos/$departamentoId" -Method PUT -Headers $headers -Body $updateData
    Write-Host "UPDATE exitoso - Nuevo nombre: $($updateResponse.data.nombre)" -ForegroundColor Green
    
    # DELETE
    Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/departamentos/$departamentoId" -Method DELETE -Headers $headers
...
try {
    ...
    $createResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/municipios" -Method POST -Headers $headers -Body $createData
    $municipioId = $createResponse.data.id
    Write-Host "CREATE exitoso - ID: $municipioId" -ForegroundColor Green
    
    # READ ALL
    $readAllResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/municipios" -Method GET -Headers $headers
    Write-Host "READ ALL exitoso - Total: $($readAllResponse.data.Count)" -ForegroundColor Green
    
    # READ BY ID
    $readByIdResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/municipios/$municipioId" -Method GET -Headers $headers
    Write-Host "READ BY ID exitoso - Nombre: $($readByIdResponse.data.nombre)" -ForegroundColor Green
    
    # UPDATE
    $updateData = @{ nombre = "Municipio Test ACTUALIZADO" } | ConvertTo-Json
    $updateResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/municipios/$municipioId" -Method PUT -Headers $headers -Body $updateData
    Write-Host "UPDATE exitoso - Nuevo nombre: $($updateResponse.data.nombre)" -ForegroundColor Green
    
    # DELETE
    Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/municipios/$municipioId" -Method DELETE -Headers $headers
    Write-Host "DELETE exitoso" -ForegroundColor Green
...
try {
    ...
    $createResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/parentescos" -Method POST -Headers $headers -Body $createData
    $parentescoId = $createResponse.data.id
    Write-Host "CREATE exitoso - ID: $parentescoId" -ForegroundColor Green
    
    # READ ALL
    $readAllResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/parentescos" -Method GET -Headers $headers
    Write-Host "READ ALL exitoso - Total: $($readAllResponse.data.Count)" -ForegroundColor Green
    
    # READ BY ID
    $readByIdResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/parentescos/$parentescoId" -Method GET -Headers $headers
    Write-Host "READ BY ID exitoso - Nombre: $($readByIdResponse.data.nombre)" -ForegroundColor Green
    
    # UPDATE
    $updateData = @{ nombre = "Parentesco Test ACTUALIZADO" } | ConvertTo-Json
    $updateResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/parentescos/$parentescoId" -Method PUT -Headers $headers -Body $updateData
    Write-Host "UPDATE exitoso - Nuevo nombre: $($updateResponse.data.nombre)" -ForegroundColor Green
    
    # DELETE
    Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/parentescos/$parentescoId" -Method DELETE -Headers $headers
    Write-Host "DELETE exitoso" -ForegroundColor Green
...
try {
    ...
    $createResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/enfermedades" -Method POST -Headers $headers -Body $createData
    $enfermedadId = $createResponse.data.id_enfermedad
    Write-Host "CREATE exitoso - ID: $enfermedadId" -ForegroundColor Green
    
    # READ ALL
    $readAllResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/enfermedades" -Method GET -Headers $headers
    Write-Host "READ ALL exitoso - Total: $($readAllResponse.data.Count)" -ForegroundColor Green
    
    # READ BY ID
    $readByIdResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/enfermedades/$enfermedadId" -Method GET -Headers $headers
    Write-Host "READ BY ID exitoso - Nombre: $($readByIdResponse.data.nombre)" -ForegroundColor Green
    
    # UPDATE
    $updateData = @{ nombre = "Enfermedad Test ACTUALIZADA" } | ConvertTo-Json
    $updateResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/enfermedades/$enfermedadId" -Method PUT -Headers $headers -Body $updateData
    Write-Host "UPDATE exitoso - Nuevo nombre: $($updateResponse.data.nombre)" -ForegroundColor Green
    
    # DELETE
    Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/enfermedades/$enfermedadId" -Method DELETE -Headers $headers
    Write-Host "DELETE exitoso" -ForegroundColor Green
...
try {
    ...
    $createResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/sexos" -Method POST -Headers $headers -Body $createData
    $sexoId = $createResponse.data.id
    Write-Host "CREATE exitoso - ID: $sexoId" -ForegroundColor Green
    
    # READ ALL
    $readAllResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/sexos" -Method GET -Headers $headers
    Write-Host "READ ALL exitoso - Total: $($readAllResponse.data.Count)" -ForegroundColor Green
    
    # READ BY ID
    $readByIdResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/sexos/$sexoId" -Method GET -Headers $headers
    Write-Host "READ BY ID exitoso - Nombre: $($readByIdResponse.data.nombre)" -ForegroundColor Green
    
    # UPDATE
    $updateData = @{ nombre = "Sexo Test ACTUALIZADO" } | ConvertTo-Json
    $updateResponse = Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/sexos/$sexoId" -Method PUT -Headers $headers -Body $updateData
    Write-Host "UPDATE exitoso - Nuevo nombre: $($updateResponse.data.nombre)" -ForegroundColor Green
    
    # DELETE
    Invoke-RestMethod -Uri "http://localhost:5000/api/catalog/sexos/$sexoId" -Method DELETE -Headers $headers
    Write-Host "DELETE exitoso" -ForegroundColor Green
