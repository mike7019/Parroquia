...
log "Aplicación disponible en: http://$(hostname -I | awk '{print $1}'):3000"
log "También disponible en: http://localhost:3000"
log "Documentación Swagger: http://localhost:3000/api-docs"
