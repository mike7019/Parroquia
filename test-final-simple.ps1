...
Write-Host "=== PRUEBA FINAL ENCUESTA ===" -ForegroundColor Green
...
Write-Host "Usando IDs unicos: $idPadre, $idMadre, $idDifunto" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "Miembros difuntos: $($encuestaCompleta.deceasedMembers.Count)" -ForegroundColor Cyan
    Write-Host "Direccion: $($encuestaCompleta.informacionGeneral.direccion)" -ForegroundColor Cyan
...
Write-Host "`nPRUEBA COMPLETA FINALIZADA!" -ForegroundColor Green
